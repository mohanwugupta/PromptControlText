#!/bin/bash
#SBATCH --job-name=pct_llama31_8b
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
#SBATCH --output=/scratch/gpfs/JORDANAT/mg9965/PromptControlText/logs/pct_llama31_8b_%j.out
#SBATCH --error=/scratch/gpfs/JORDANAT/mg9965/PromptControlText/logs/pct_llama31_8b_%j.err

# =============================================================================
# Prompt-Level Safety Controllers Pipeline — Llama-3.1-8B-Instruct
# =============================================================================
