#!/bin/bash
#SBATCH --job-name=pct_ctrl_llama33_70b
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
#SBATCH --time=2:00:00
#SBATCH --output=/scratch/gpfs/JORDANAT/mg9965/PromptControlText/logs/pct_ctrl_llama33_70b_%j.out
#SBATCH --error=/scratch/gpfs/JORDANAT/mg9965/PromptControlText/logs/pct_ctrl_llama33_70b_%j.err

# =============================================================================
# Phase 1 Control Condition — Llama-3.3-70B-Instruct (No system prompt)
# =============================================================================

set -eo pipefail

MODEL_DIR_NAME=meta-llama--Llama-3.3-70B-Instruct
MODEL_SLUG=llama33_70b
