#!/bin/bash
#SBATCH --job-name=pct_ctrl_qwen2_7b
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
#SBATCH --time=2:00:00
#SBATCH --output=/scratch/gpfs/JORDANAT/mg9965/PromptControlText/logs/pct_ctrl_qwen2_7b_%j.out
#SBATCH --error=/scratch/gpfs/JORDANAT/mg9965/PromptControlText/logs/pct_ctrl_qwen2_7b_%j.err

# =============================================================================
# Phase 1 Control Condition — Qwen2-7B-Instruct (No system prompt)
# =============================================================================
...
echo "=========================================="
echo "Phase 1 Control — No-system-prompt (Qwen2-7B-Instruct)"
echo "=========================================="
