...
#SBATCH --time=2:00:00
#SBATCH --output=/scratch/gpfs/JORDANAT/mg9965/PromptControlText/logs/pct_ctrl_mistral_7b_%j.out
#SBATCH --error=/scratch/gpfs/JORDANAT/mg9965/PromptControlText/logs/pct_ctrl_mistral_7b_%j.err

# =============================================================================
# Phase 1 Control Condition — Mistral-7B-Instruct (No system prompt)
# =============================================================================
